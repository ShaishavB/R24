...
@property (strong, nonatomic, readonly) NSString *getBalancePath;
@property (strong, nonatomic, readonly) NSString *processChargePath;
@property (strong, nonatomic, readonly) NSString *getChargeStatusPath;
@property (strong, nonatomic, readonly) NSString *kuberEndpoint;
